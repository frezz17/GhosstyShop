...
from html import escape # Додано для безпеки тексту
...
# ================== КОНФІГУРАЦІЯ / CONFIG ==================
# ⚠️ УВАГА: Замініть цей токен на свій новий, отриманий від BotFather!
TOKEN = "ВСТАВТЕ_СЮДИ_ВАШ_НОВИЙ_ТОКЕН" 
...
PRODUCTS = {
    ...
    104: {"name": "🌴 Jungle Boys White", "cat": "hhc", "price": 859, "img": "https://i.ibb.co/Zzk29HMy/Ghost-Vape-5.jpg", "variants": ["2мл рідини"],
          "desc": "✨ Ефект: Максимальна сила. Ейфорія та релакс. Індика.\n🌴 Смак: Тропічні фрукти."},
    ...
    200: {"name": "⚡ Vaporesso XROS 4", "cat": "pod", "price": 699, "img": "https://vandalvape.life/image/cache/catalog/pod/vaporesso/xros%204/Vaporesso-Xros-4-Black-1000x1000.webp", "variants": ["Black", "Purple", "Blue"], 
          "desc": "⚙️ Потужність: 1000mAh\n🎨 Колір: Black/Purple/Blue\n🔧 Особливості: 3 режими потужності, компактний дизайн"},
    201: {"name": "🚀 Vaporesso XROS 5", "cat": "pod", "price": 799, "img": "https://vandalvape.life/image/cache/catalog/pod/vaporesso/xros%204/Vaporesso-Xros-4-Black-1000x1000.webp", "variants": ["Black", "Pink", "Blue"],
          "desc": "⚙️ Потужність: 1200mAh\n🎨 Колір: Black/Pink/Blue\n🔧 Особливості: Покращений обдув, швидка зарядка Type-C"},
    202: {"name": "🧊 XROS 4 Nano", "cat": "pod", "price": 719, "img": "https://vandalvape.life/image/cache/catalog/pod/vaporesso/xros%204%20nano/Xros-4-Nano-Twilight-Purple-1000x1000.webp", "variants": ["Black", "Blue", "Silver"],
          "desc": "⚙️ Потужність: 900mAh\n🎨 Колір: Black/Blue/Silver\n🔧 Особливості: Великий екран, регулювання обдуву"},
    203: {"name": "💎 XROS Pro", "cat": "pod", "price": 929, "img": "https://vandalvape.life/image/cache/catalog/pod/vaporesso/xros%20pro/Vaporesso-XROS-PRO-Black-1000x1000.webp", "variants": ["Pink", "Black", "Red"],
          "desc": "⚙️ Потужність: 1100mAh\n🎨 Колір: Pink/Black/Red\n🔧 Особливості: Преміум, кнопка блокування, потужність до 30W"},
    204: {"name": "🔥 Vmate Mini", "cat": "pod", "price": 570, "img": "https://vandalvape.life/image/cache/catalog/pod/voopoo/vmate%20e/VooPoo-VMATE-E-Classic-Black-1000x1000.webp", "variants": ["Black", "Pink", "Red"],
          "desc": "⚙️ Потужність: 800mAh\n🎨 Колір: Black/Pink/Red\n🔧 Особливості: Легкий, компактний, автозатяжка"},

    # --- РІДИНИ (LIQUIDS) ---
    300: {"name": "🍋 Chaser Balance", "cat": "liquid", "price": 229, "img": "https://i.ibb.co/fFkCWXj/Chaser-Balance.jpg", "variants": ["50mg", "65mg", "80mg"],
          "desc": "🍋 Смак: Енергетик, кислий з бульбашками\n✨ Ефект: Бадьорість, легка ейфорія"},
    301: {"name": "🍓 Chaser Berry", "cat": "liquid", "price": 229, "img": "https://i.ibb.co/qxgZrDx/Chaser-Berry.jpg", "variants": ["50mg", "65mg", "80mg"],
          "desc": "🍓 Смак: Ягідний лимонад, малина з лимоном\n✨ Ефект: Розслаблення та соціальна ейфорія"},
    302: {"name": "🍏 Chaser Green", "cat": "liquid", "price": 229, "img": "https://i.ibb.co/XYvK5dP/Chaser-Green.jpg", "variants": ["50mg", "65mg", "80mg"],
          "desc": "🍏 Смак: Зелене яблуко, освіжаюче\n✨ Ефект: Легке піднесення настрою"},
    303: {"name": "🥭 Chaser Mango", "cat": "liquid", "price": 249, "img": "https://i.ibb.co/5WvYGH9/Chaser-Mango.jpg", "variants": ["50mg", "65mg", "80mg"],
          "desc": "🥭 Смак: Соковите манго, тропічні нотки\n✨ Ефект: Релакс та ейфорія"},
    304: {"name": "🍫 Chaser Choco", "cat": "liquid", "price": 259, "img": "https://i.ibb.co/HnpX1yH/Chaser-Choco.jpg", "variants": ["50mg", "65mg", "80mg"],
          "desc": "🍫 Смак: Шоколадний десерт\n✨ Ефект: Солодка ейфорія та релакс"},
}
...
def get_main_kb():
    return InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🔋 Поди", callback_data="list_pod")],
        [InlineKeyboardButton("💧 Рідини", callback_data="list_liquid"),
        [InlineKeyboardButton("📜 Політика", callback_data="policy")],
        [InlineKeyboardButton("📍 Обрати Місто", callback_data="sel_city_menu"),
...
async def safe_edit_media(message, media, reply_markup=None):
    try:
        ...
        logger.error(f"Помилка редагування медіа: {e}")
        if "Message is not modified" not in str(e):
            await message.reply_text("⚠️ Сталася помилка при оновленні меню.")

async def safe_edit_caption(message, caption, reply_markup=None, parse_mode="HTML"):
    try:
        await message.edit_caption(caption=caption, parse_mode=parse_mode, reply_markup=reply_markup)
    except BadRequest as e:
        logger.error(f"Помилка редагування тексту: {e}")
        if "Message is not modified" not in str(e):
            pass
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Екрануємо ім'я для безпеки HTML
    safe_name = escape(user.first_name)

    welcome_text = (
        f"👋 <b>Вітаємо в Ghosty Shop, {safe_name}!</b> 👻\n\n"
        ...
        f"🎁 <b>Твій персональний Промокод:</b> <code>{context.user_data['promo']}</code>\n"
        f"(-35% на все + рідина у подарунок на перше замовлення!)"
    )
    
    # Виправлено: прибрано дублювання коду та конфлікт parse_mode
    if update.message:
        ...
        await safe_edit_media(
            ...
            InputMediaPhoto(media=WELCOME_PHOTO, caption=welcome_text, parse_mode="HTML"), 
            reply_markup=get_main_kb()
        )
...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == "wait_promo":
        if text == ud.get("promo"):
            ...
            ud["input_state"] = None
            await update.message.reply_text("✅ <b>Промокод застосовано!</b> Всі ціни знижено на 35%.", parse_mode="HTML")
        ...
        await update.message.reply_text("📮 <b>Введіть номер відділення або поштомату Нової Пошти:</b>\n(Наприклад: Відділення 25 або 4455)", parse_mode="HTML")
...
async def show_cart(update: Update, context: ContextTypes.DEFAULT_TYPE, new_msg=False):
    ...
    # Використовуємо HTML для узгодженості
    if new_msg:
        await update.message.reply_photo(photo=CART_PHOTO, caption=text, parse_mode="HTML", reply_markup=kb)
    else:
        await safe_edit_media(update.callback_query.message, InputMediaPhoto(media=CART_PHOTO, caption=text, parse_mode="HTML"), reply_markup=kb)
...
async def callbacks(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "main_menu":
        ...
        await safe_edit_caption(q.message, "📦 <b>Оберіть категорію товару:</b>", kb)
        ...
        vip_text = f"💎 VIP-Статус: <b>АКТИВНИЙ</b> (Безкоштовна доставка до {VIP_END_DATE}) ✅" if is_vip else "💎 VIP-Статус: ❌ Неактивний"
        ...
        txt = (
            ...
            f"👤 Username: {username}\n"
            f"🎫 Промо: <code>{ud.get('promo','❌')}</code>\n\n"
            f"{vip_text}\n"
            f"🔗 <b>Твоє реферальне посилання:</b>\n<code>{ref_link}</code>\n"
            f"<i>(Запроси друга та отримай VIP статус! Переваги: безкоштовна доставка)</i>\n\n"
            f"📍 Місто: {city_stat}\n"
            f"🏘 Район: {dist_stat}\n"
            f"━━━━━━━━━━━━━━━━━━"
        )
        ...
        if data == "sel_city_menu":
            ...
            await safe_edit_caption(q.message, "📍 <b>Обери своє місто:</b>", InlineKeyboardMarkup(btns))
            ...
            caption = f"🏙 <b>Місто: {current_city}</b>\n{status_text}"
        ...
        await safe_edit_caption(q.message, "⬇️ <b>Оберіть товар:</b>", InlineKeyboardMarkup(btns))

    elif data.startswith("prod_"):
        pid = int(data.split("_")[1])
        p = PRODUCTS[pid]
        p_active = ud.get("promo_active")
        price_text = f"❌ ~{p['price']} грн~\n✅ <b>{int(p['price']*DISCOUNT_MULT)} грн</b>" if p_active else f"💰 <b>{p['price']} грн</b>"
        ...
        # Використовуємо HTML для товару
        await safe_edit_media(q.message, InputMediaPhoto(media=p["img"], caption=caption, parse_mode="HTML"), reply_markup=InlineKeyboardMarkup(btns))
...
async def finalize_order(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"✅ <b>Замовлення {order_id} сформовано!</b>\nНатисніть кнопку нижче, щоб відправити дані менеджеру.", 
        parse_mode="HTML", 
        reply_markup=kb
    )
